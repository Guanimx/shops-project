...
if ($name === '') {
    jsonResponse(['message' => 'กรุณากรอกชื่อ-นามสกุล'], 400);
}

if ($email === '') {
    jsonResponse(['message' => 'กรุณากรอกอีเมล'], 400);
}

if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
    jsonResponse(['message' => 'กรุณากรอกอีเมลให้ถูกต้อง'], 400);
}

if ($username === '') {
    jsonResponse(['message' => 'กรุณากรอกชื่อผู้ใช้'], 400);
}

if ($password !== '' && strlen($password) < 4) {
    jsonResponse(['message' => 'รหัสผ่านต้องมีอย่างน้อย 4 ตัวอักษร'], 400);
}
